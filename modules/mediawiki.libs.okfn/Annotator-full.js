...
Range.SerializedRange = (function() {
  ...
  SerializedRange.prototype.normalize = function(root) {
    var contains, length, node, p, range, targetOffset, tn, _i, _j, _len, _len1, _ref, _ref1;
    range = {};
    _ref = ['start', 'end'];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      p = _ref[_i];
...
Annotator = (function(_super) {
  ...
  function Annotator(element, options) {
    var _this = this;
    this.onDeleteAnnotation = function(annotation) {
      return Annotator.prototype.onDeleteAnnotation.apply(_this, arguments);
    };
    this.onEditAnnotation = function(annotation) {
      return Annotator.prototype.onEditAnnotation.apply(_this, arguments);
    };
    this.onAdderClick = function(event) {
      return Annotator.prototype.onAdderClick.apply(_this, arguments);
    };
    this.onAdderMousedown = function(event) {
      return Annotator.prototype.onAdderMousedown.apply(_this, arguments);
    };
    this.onHighlightMouseover = function(event) {
      return Annotator.prototype.onHighlightMouseover.apply(_this, arguments);
    };
    this.checkForEndSelection = function(event) {
      return Annotator.prototype.checkForEndSelection.apply(_this, arguments);
    };
    this.checkForStartSelection = function(event) {
      return Annotator.prototype.checkForStartSelection.apply(_this, arguments);
    };
    this.clearViewerHideTimer = function() {
      return Annotator.prototype.clearViewerHideTimer.apply(_this, arguments);
    };
    this.startViewerHideTimer = function() {
      return Annotator.prototype.startViewerHideTimer.apply(_this, arguments);
    };
    this.showViewer = function(annotations, location) {
      return Annotator.prototype.showViewer.apply(_this, arguments);
    };
    this.onEditorSubmit = function(annotation) {
      return Annotator.prototype.onEditorSubmit.apply(_this, arguments);
    };
    this.onEditorHide = function() {
      return Annotator.prototype.onEditorHide.apply(_this, arguments);
    };
    this.showEditor = function(annotation, location) {
      return Annotator.prototype.showEditor.apply(_this, arguments);
    };
...
Annotator.Editor = (function(_super) {
  ...
  function Editor(options) {
    var _this = this;
    this.onCancelButtonMouseover = function() {
      return Editor.prototype.onCancelButtonMouseover.apply(_this, arguments);
    };
    this.processKeypress = function(event) {
      return Editor.prototype.processKeypress.apply(_this, arguments);
    };
    this.submit = function(event) {
      return Editor.prototype.submit.apply(_this, arguments);
    };
    this.load = function(annotation) {
      return Editor.prototype.load.apply(_this, arguments);
    };
    this.hide = function(event) {
      return Editor.prototype.hide.apply(_this, arguments);
    };
    this.show = function(event) {
      return Editor.prototype.show.apply(_this, arguments);
    };
...
Annotator.Viewer = (function(_super) {
  ...
  function Viewer(options) {
    ...
    this.onDeleteClick = function(event) {
      return Viewer.prototype.onDeleteClick.apply(_this, arguments);
    };
    this.onEditClick = function(event) {
      return Viewer.prototype.onEditClick.apply(_this, arguments);
    };
    this.load = function(annotations) {
      return Viewer.prototype.load.apply(_this, arguments);
    };
    this.hide = function(event) {
      return Viewer.prototype.hide.apply(_this, arguments);
    };
    this.show = function(event) {
      return Viewer.prototype.show.apply(_this, arguments);
    };
...
Annotator.Notification = (function(_super) {
  ...
  function Notification(options) {
    var _this = this;
    this.hide = function() {
      return Notification.prototype.hide.apply(_this, arguments);
    };
    this.show = function(message, status) {
      if (status == null) {
        status = Annotator.Notification.INFO;
      }
      return Notification.prototype.show.apply(_this, arguments);
    };
...
Annotator.Plugin.Store = (function(_super) {
  ...
  function Store(element, options) {
    ...
    this._onError = function(xhr) {
      return Store.prototype._onError.apply(_this, arguments);
    };
    this._onLoadAnnotationsFromSearch = function(data) {
      if (data == null) {
        data = {};
      }
      return Store.prototype._onLoadAnnotationsFromSearch.apply(_this, arguments);
    };
    this._onLoadAnnotations = function(data) {
      if (data == null) {
        data = [];
      }
      return Store.prototype._onLoadAnnotations.apply(_this, arguments);
    };
    this._getAnnotations = function() {
      return Store.prototype._getAnnotations.apply(_this, arguments);
    };
...
Annotator.Plugin.Permissions = (function(_super) {
  ...
  function Permissions(element, options) {
    var _this = this;
    this._setAuthFromToken = function(token) {
      return Permissions.prototype._setAuthFromToken.apply(_this, arguments);
    };
    this.updateViewer = function(field, annotation, controls) {
      return Permissions.prototype.updateViewer.apply(_this, arguments);
    };
    this.updateAnnotationPermissions = function(type, field, annotation) {
      return Permissions.prototype.updateAnnotationPermissions.apply(_this, arguments);
    };
    this.updatePermissionsField = function(action, field, annotation) {
      return Permissions.prototype.updatePermissionsField.apply(_this, arguments);
    };
    this.addFieldsToAnnotation = function(annotation) {
      return Permissions.prototype.addFieldsToAnnotation.apply(_this, arguments);
    };
...
Annotator.Plugin.AnnotateItPermissions = (function(_super) {
  ...
  function AnnotateItPermissions() {
    var _this = this;
    this._setAuthFromToken = function(token) {
      return AnnotateItPermissions.prototype._setAuthFromToken.apply(_this, arguments);
    };
    this.updateAnnotationPermissions = function(type, field, annotation) {
      return AnnotateItPermissions.prototype.updateAnnotationPermissions.apply(_this, arguments);
    };
    this.updatePermissionsField = function(action, field, annotation) {
      return AnnotateItPermissions.prototype.updatePermissionsField.apply(_this, arguments);
    };
    this.addFieldsToAnnotation = function(annotation) {
      return AnnotateItPermissions.prototype.addFieldsToAnnotation.apply(_this, arguments);
    };
...
Annotator.Plugin.Filter = (function(_super) {
  ...
  function Filter(element, options) {
    var _base,
      _this = this;
    this._onPreviousClick = function(event) {
      return Filter.prototype._onPreviousClick.apply(_this, arguments);
    };
    this._onNextClick = function(event) {
      return Filter.prototype._onNextClick.apply(_this, arguments);
    };
    this._onFilterKeyup = function(event) {
      return Filter.prototype._onFilterKeyup.apply(_this, arguments);
    };
    this._onFilterBlur = function(event) {
      return Filter.prototype._onFilterBlur.apply(_this, arguments);
    };
    this._onFilterFocus = function(event) {
      return Filter.prototype._onFilterFocus.apply(_this, arguments);
    };
    this.updateHighlights = function() {
      return Filter.prototype.updateHighlights.apply(_this, arguments);
    };
...
Annotator.Plugin.Markdown = (function(_super) {
  ...
  function Markdown(element, options) {
    var _this = this;
    this.updateTextField = function(field, annotation) {
      return Markdown.prototype.updateTextField.apply(_this, arguments);
    };
...
Annotator.Plugin.Tags = (function(_super) {
  ...
  function Tags() {
    var _this = this;
    this.setAnnotationTags = function(field, annotation) {
      return Tags.prototype.setAnnotationTags.apply(_this, arguments);
    };
    this.updateField = function(field, annotation) {
      return Tags.prototype.updateField.apply(_this, arguments);
    };
